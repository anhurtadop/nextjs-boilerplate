...
export type SagaCallback<DataType = void, CallbackReturnType = unknown> = (args: { ok: boolean; message?: string; data?: DataType }) => CallbackReturnType

type ActionWithCallback<ActionType extends string, DispatchData extends {[key: string]: unknown}, ReturnData> = (data: DispatchData, callback: SagaCallback<ReturnData>) => ReturnType<typeof createAction<DispatchData & {callback: SagaCallback<ReturnData>}, ActionType>>;
